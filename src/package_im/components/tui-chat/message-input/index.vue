<template>
	<view>
		<view class="TUI-message-input-container">
			<view class="TUI-commom-function" v-if="false">
			...
			<view class="TUI-message-input">
				...
				<view class="TUI-message-input-functions" hover-class="none">
					<image class="TUI-icon" @tap="handleEmoji" src="https://file.aicar365.com/mini-program/common/face_emoji.png"></image>
					<!-- <view v-if="!sendMessageBtn" @tap="handleExtensions"><image class="TUI-icon" src="/static/assets/more.svg"></image></view> -->
					<view class="TUI-sendMessage-btn" @tap="sendTextMessage">发送</view>
				</view>
			</view>
...
import { subscribeTmpOnce } from '@/assets/js/common';
...
export default {
	...
	methods: {
      ...
      uni.requestSubscribeMessage({
        tmplIds: [subscribeTmpOnce[schoolId]],
